<template>
    <e-dialog title="新建文件夹" :visible.sync="visible" :close-on-click-modal="false" @close="onClose">
        <e-form :model="viewModel" ref="folderModel" :rules="rules" label-width="120px" label-position="right">
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <e-button :disabled="okDisabled" type="primary" @click="submit('folderModel')">确 定</e-button>
        </div>
    </e-dialog>
</template>
