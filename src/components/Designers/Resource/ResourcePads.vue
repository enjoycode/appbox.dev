...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onDeleteResource() {
                this.$channel.invoke('sys.DesignHub.DeleteResource', [this.currentRow.ID]).then(res => {
        ...
        mounted() {
            ...
            this.$channel.invoke('sys.DesignHub.GetResourceInfos', [this.target.AppID, 1]).then(res => {
